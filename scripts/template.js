...
// function templateModalCard1(pokemon, pokemonTypeColor, descriptionText, evolutionChain, movesDataTemplate) {
//   let total = pokemon.stats.reduce((sum, stat) => sum + stat.base_stat, 0);
//   let maxStat = 255;
//   let maxStatTotal = 720;
//   let typesHtml = filterTypes(pokemon);
        ...
        templateData += ` 
            <div class=" px-2 pt-1">
                ...
                <div class="dpf-sb-center mt-1">
                    <p style="width: 75px">Power: ${moveData[index].power || '—'}</p>
                    <p style="width: 55px">PP: ${moveData[index].pp || '—'}</p>
                    <p style="width: 112px">Accuracy: ${moveData[index].accuracy || '—'}%</p>
                </div>
            </div>
        `;
  }
